...
internal sealed class DeviceManagementPageControl : UserControl, IInteractiveResizeAware
{
    ...
    public DeviceManagementPageControl(DeviceManagementController controller)
    {
        ...
        _remarkTextBox = CreateTextBox("备注、维护要求、接入说明");
        _remarkTextBox.Multiline = true;
        _remarkTextBox.Height = 72;
    ...
    private Control BuildWorkspaceArea()
    {
        ...
        workspace.Controls.Add(PageChrome.CreateSectionShell("设备信息", _editorHintLabel, BuildEditorArea(), new Padding(0)), 1, 0);
        return workspace;
    }
    ...
    private Control BuildEditorArea()
    {
        ...
        AddEditorRow(layout, "备注", _remarkTextBox, true);
        return layout;
    }
    ...
    private void FillEditor(DeviceRowViewModel device)
    {
        ...
        _remarkTextBox.Text = device.Remark;
